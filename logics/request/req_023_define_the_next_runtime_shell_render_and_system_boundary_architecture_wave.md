...
# Delivery note
- This request intentionally follows the runtime convergence, product meta-flow, and unified frame-loop waves.
- It should produce the next architecture decisions needed before larger-scale combat, progression, richer render feedback, and more complex shell-owned product flows are implemented.
