...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-a-background-progress-bar-present|req-087-define-damage-share-progress-bar|improve-the-readability-of-the-game|ac1-the-request-defines-a-bounded
flowchart LR
    Request[req_087_define_damage_share_progress_bar_c] --> Problem[Improve the readability of the game]
    Problem --> Scope[Define a background progress-bar presentat]
