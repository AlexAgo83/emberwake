...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-a-shell-owned-menu-entry-and-scen|req-084-define-a-shell-owned-talent-grow|add-a-shell-owned-meta-progression-surfa|ac1-the-request-defines-a-bounded
flowchart LR
    Request[req_084_define_a_shell_owned_talent_growth] --> Problem[Add a shell-owned meta-progression surface]
    Problem --> Scope[Define a shell-owned menu entry and]
