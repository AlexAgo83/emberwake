...
# Problem
- The entity layer needs a visible debug-first render pass that makes orientation, footprint, state, and ordering obvious.
...
- Visual footprint, facing or orientation, and explicit render ordering
...
- AC2: Debug-friendly visuals expose at least orientation, footprint, and current state without depending on final art assets.
