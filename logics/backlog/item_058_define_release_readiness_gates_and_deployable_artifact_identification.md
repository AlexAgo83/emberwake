...
- This slice defines readiness gates and deployable artifact identity so releases are not treated informally.

# Scope
- In: Release-readiness criteria, deployable artifact identity, and release entry rules.
