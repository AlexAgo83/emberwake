...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-vivid-red-rendering-for-non-trave|req-077-define-a-vivid-blocking-obstacle|restore-clear-visual-readability-for-non|ac1-the-request-defines-a-visibility-fix
flowchart LR
    Request[req_077_define_a_vivid_blocking_obstacle_v] --> Problem[Restore clear visual readability for non-t]
    Problem --> Scope[Define vivid red rendering for non]
