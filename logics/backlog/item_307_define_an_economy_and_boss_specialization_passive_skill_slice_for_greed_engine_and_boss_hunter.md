## item_307_define_an_economy_and_boss_specialization_passive_skill_slice_for_greed_engine_and_boss_hunter - Define an economy and boss-specialization passive skill slice for Greed Engine and Boss Hunter
> From version: 0.5.1
> Schema version: 1.0
> Status: Ready
> Understanding: 95%
...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-an-economy-and-boss-specializatio|req-082-define-a-second-survivor-style-s|expand-the-current-emberwake-build-roste|ac1-the-request-defines-a-curated
flowchart LR
    Request[req_082_define_a_second_survivor_style_ski] --> Problem[Expand the current Emberwake build roster]
    Problem --> Scope[Define an economy and boss-specialization]
