...
- Project structure for app shell, runtime, rendering integration, and shared utilities
...
- AC4: The project structure separates app shell concerns, runtime concerns, rendering integration, and shared utilities so later requests can add features without a structural rewrite.
