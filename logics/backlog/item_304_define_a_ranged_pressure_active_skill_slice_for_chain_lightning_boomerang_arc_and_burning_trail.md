## item_304_define_a_ranged_pressure_active_skill_slice_for_chain_lightning_boomerang_arc_and_burning_trail - Define a ranged pressure active skill slice for Chain Lightning Boomerang Arc and Burning Trail
> From version: 0.5.1
> Schema version: 1.0
> Status: Ready
> Understanding: 95%
...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-a-ranged-pressure-active-skill-sl|req-082-define-a-second-survivor-style-s|expand-the-current-emberwake-build-roste|ac1-the-request-defines-a-curated
flowchart LR
    Request[req_082_define_a_second_survivor_style_ski] --> Problem[Expand the current Emberwake build roster]
    Problem --> Scope[Define a ranged pressure active skill]
