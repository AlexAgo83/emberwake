## item_286_define_save_game_feedback_toast_lifecycle_with_stacking_and_five_second_fade_out - Define save game feedback toast lifecycle with stacking and five second fade out
> From version: 0.5.1
> Schema version: 1.0
> Status: Ready
> Understanding: 95%
...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-save-game-feedback-toast-lifecycl|req-076-define-a-shell-owned-toast-notif|give-the-save-game-action-a|ac1-the-request-defines-a-shell-owned
flowchart LR
    Request[req_076_define_a_shell_owned_toast_notific] --> Problem[Give the Save game action a]
    Problem --> Scope[Define save game feedback toast lifecycle]
