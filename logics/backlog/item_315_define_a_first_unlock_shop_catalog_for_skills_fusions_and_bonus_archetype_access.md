## item_315_define_a_first_unlock_shop_catalog_for_skills_fusions_and_bonus_archetype_access - Define a first unlock shop catalog for skills fusions and bonus archetype access
> From version: 0.5.1
> Schema version: 1.0
> Status: Done
> Understanding: 97%
...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-a-first-unlock-shop-catalog-for-s|req-084-define-a-shell-owned-talent-grow|add-a-shell-owned-meta-progression-surfa|ac1-the-request-defines-a-bounded
flowchart LR
    Request[req_084_define_a_shell_owned_talent_growth] --> Problem[Add a shell-owned meta-progression surface]
    Problem --> Scope[Define a first unlock shop catalog]
