...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-a-shared-local-meta-profile-bound|req-085-define-a-persistent-meta-profile|define-a-coherent-persistent-meta-profil|ac1-the-request-defines-a-shared
flowchart LR
    Request[req_085_define_a_persistent_meta_profile_c] --> Problem[Define a coherent persistent meta-profile]
    Problem --> Scope[Define a shared local meta-profile boundar]
