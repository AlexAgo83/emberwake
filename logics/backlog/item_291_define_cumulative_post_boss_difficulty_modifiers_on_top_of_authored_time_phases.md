## item_291_define_cumulative_post_boss_difficulty_modifiers_on_top_of_authored_time_phases - Define cumulative post boss difficulty modifiers on top of authored time phases
> From version: 0.5.1
> Schema version: 1.0
> Status: Done
> Understanding: 96%
...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-cumulative-post-boss-difficulty-m|req-078-define-a-boss-defeat-driven-perm|add-a-second-permanent-difficulty-lever|ac1-the-request-defines-a-boss-defeat-dr
flowchart LR
    Request[req_078_define_a_boss_defeat_driven_perman] --> Problem[Add a second permanent difficulty lever]
    Problem --> Scope[Define cumulative post boss difficulty mod]
