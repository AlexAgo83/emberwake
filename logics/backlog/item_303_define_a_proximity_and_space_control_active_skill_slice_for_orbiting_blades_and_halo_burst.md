## item_303_define_a_proximity_and_space_control_active_skill_slice_for_orbiting_blades_and_halo_burst - Define a proximity and space-control active skill slice for Orbiting Blades and Halo Burst
> From version: 0.5.1
> Schema version: 1.0
> Status: Done
> Understanding: 98%
...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-a-proximity-and-space-control-act|req-082-define-a-second-survivor-style-s|expand-the-current-emberwake-build-roste|ac1-the-request-defines-a-curated
flowchart LR
    Request[req_082_define_a_second_survivor_style_ski] --> Problem[Expand the current Emberwake build roster]
    Problem --> Scope[Define a proximity and space-control activ]
