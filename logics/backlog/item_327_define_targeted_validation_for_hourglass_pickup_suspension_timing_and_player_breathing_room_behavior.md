...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-targeted-validation-for-hourglass|req-086-define-a-time-stop-hourglass-pic|add-a-new-world-utility-pickup|ac1-the-request-defines-a-bounded
flowchart LR
    Request[req_086_define_a_time_stop_hourglass_picku] --> Problem[Add a new world utility pickup]
    Problem --> Scope[Define targeted validation for hourglass p]
