## item_283_define_nearby_pickup_cap_release_and_respawn_behavior_after_utility_pickup_expiration - Define nearby pickup cap release and respawn behavior after utility pickup expiration
> From version: 0.5.1
> Schema version: 1.0
> Status: Done
> Understanding: 94%
...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-nearby-pickup-cap-release-and-res|req-075-define-offscreen-stale-pickup-ex|let-gold-and-healing-kit-pickups-disappe|ac1-the-request-defines-a-stale
flowchart LR
    Request[req_075_define_offscreen_stale_pickup_expi] --> Problem[Let gold and healing-kit pickups disappear]
    Problem --> Scope[Define nearby pickup cap release and]
