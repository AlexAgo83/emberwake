## item_305_define_a_control_and_pickup_flow_active_skill_slice_for_frost_nova_and_vacuum_pulse - Define a control and pickup-flow active skill slice for Frost Nova and Vacuum Pulse
> From version: 0.5.1
> Schema version: 1.0
> Status: Done
> Understanding: 98%
...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-a-control-and-pickup-flow-active-|req-082-define-a-second-survivor-style-s|expand-the-current-emberwake-build-roste|ac1-the-request-defines-a-curated
flowchart LR
    Request[req_082_define_a_second_survivor_style_ski] --> Problem[Expand the current Emberwake build roster]
    Problem --> Scope[Define a control and pickup-flow active]
