## item_316_define_a_first_ranked_talent_roster_with_escalating_cost_tiers_and_late_survivability_gating - Define a first ranked talent roster with escalating cost tiers and late survivability gating
> From version: 0.5.1
> Schema version: 1.0
> Status: Done
> Understanding: 97%
...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-a-first-ranked-talent-roster-with|req-084-define-a-shell-owned-talent-grow|add-a-shell-owned-meta-progression-surfa|ac1-the-request-defines-a-bounded
flowchart LR
    Request[req_084_define_a_shell_owned_talent_growth] --> Problem[Add a shell-owned meta-progression surface]
    Problem --> Scope[Define a first ranked talent roster]
...
# Closure
- Proof: `src/app/model/metaProgression.ts`, `src/app/components/AppMetaScenePanel.tsx`.
