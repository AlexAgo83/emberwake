## item_323_define_targeted_validation_for_cross_run_meta_profile_persistence_of_gold_grimoire_and_bestiary_data - Define targeted validation for cross-run meta-profile persistence of gold Grimoire and Bestiary data
> From version: 0.5.1
> Schema version: 1.0
> Status: Ready
> Understanding: 97%
...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-targeted-validation-for-cross-run|req-085-define-a-persistent-meta-profile|define-a-coherent-persistent-meta-profil|ac1-the-request-defines-a-shared
flowchart LR
    Request[req_085_define_a_persistent_meta_profile_c] --> Problem[Define a coherent persistent meta-profile]
    Problem --> Scope[Define targeted validation for cross-run m]
