## item_321_define_persistent_grimoire_discovery_progression_across_runs - Define persistent Grimoire discovery progression across runs
> From version: 0.5.1
> Schema version: 1.0
> Status: Done
> Understanding: 97%
...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-persistent-grimoire-discovery-pro|req-085-define-a-persistent-meta-profile|define-a-coherent-persistent-meta-profil|ac1-the-request-defines-a-shared
flowchart LR
    Request[req_085_define_a_persistent_meta_profile_c] --> Problem[Define a coherent persistent meta-profile]
    Problem --> Scope[Define persistent Grimoire discovery progr]
