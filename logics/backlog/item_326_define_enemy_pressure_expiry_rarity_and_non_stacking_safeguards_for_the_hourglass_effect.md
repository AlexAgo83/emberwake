...
# Closure
- Proof: `games/emberwake/src/runtime/entitySimulationSpawn.ts`, `games/emberwake/src/runtime/entitySimulationCombat.ts`, `src/game/entities/model/entitySimulation.test.ts`.
