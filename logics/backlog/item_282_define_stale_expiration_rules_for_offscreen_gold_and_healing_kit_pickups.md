...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-stale-expiration-rules-for-offscr|req-075-define-offscreen-stale-pickup-ex|let-gold-and-healing-kit-pickups-disappe|ac1-the-request-defines-a-stale
flowchart LR
    Request[req_075_define_offscreen_stale_pickup_expi] --> Problem[Let gold and healing-kit pickups disappear]
    Problem --> Scope[Define stale expiration rules for offscree]
