...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-targeted-validation-for-new-hosti|req-080-define-two-new-hostile-archetype|add-a-smaller-faster-hostile-archetype|ac1-the-request-defines-a-bounded
flowchart LR
    Request[req_080_define_two_new_hostile_archetypes_] --> Problem[Add a smaller faster hostile archetype]
    Problem --> Scope[Define targeted validation for new hostile]
