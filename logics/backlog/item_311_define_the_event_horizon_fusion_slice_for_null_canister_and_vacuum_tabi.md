...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-the-event-horizon-fusion-slice-fo|req-083-define-a-missing-fusion-completi|complete-the-first-playable-fusion-roste|ac1-the-request-defines-a-bounded
flowchart LR
    Request[req_083_define_a_missing_fusion_completion] --> Problem[Complete the first playable fusion roster]
    Problem --> Scope[Define the Event Horizon fusion slice]
