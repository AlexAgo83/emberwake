## item_299_define_a_magnet_pickup_that_pulls_all_active_xp_crystals_toward_the_player - Define a magnet pickup that pulls all active XP crystals toward the player
> From version: 0.5.1
> Schema version: 1.0
> Status: Done
> Understanding: 95%
...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-a-magnet-pickup-that-pulls-all-ac|req-081-define-a-crystal-magnet-pickup-a|add-a-new-magnet-style-pickup-among|ac1-the-request-defines-a-bounded
flowchart LR
    Request[req_081_define_a_crystal_magnet_pickup_and] --> Problem[Add a new magnet-style pickup among]
    Problem --> Scope[Define a magnet pickup that pulls]
