## item_306_define_a_defensive_and_execution_passive_skill_slice_for_thorn_mail_execution_sigil_and_emergency_aegis - Define a defensive and execution passive skill slice for Thorn Mail Execution Sigil and Emergency Aegis
> From version: 0.5.1
> Schema version: 1.0
> Status: Ready
> Understanding: 95%
...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-a-defensive-and-execution-passive|req-082-define-a-second-survivor-style-s|expand-the-current-emberwake-build-roste|ac1-the-request-defines-a-curated
flowchart LR
    Request[req_082_define_a_second_survivor_style_ski] --> Problem[Expand the current Emberwake build roster]
    Problem --> Scope[Define a defensive and execution passive]
