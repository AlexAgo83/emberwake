## item_301_define_attraction_first_crystal_travel_and_arrival_based_xp_consumption - Define attraction first crystal travel and arrival based XP consumption
> From version: 0.5.1
> Schema version: 1.0
> Status: Done
> Understanding: 95%
...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-attraction-first-crystal-travel-a|req-081-define-a-crystal-magnet-pickup-a|add-a-new-magnet-style-pickup-among|ac1-the-request-defines-a-bounded
flowchart LR
    Request[req_081_define_a_crystal_magnet_pickup_and] --> Problem[Add a new magnet-style pickup among]
    Problem --> Scope[Define attraction first crystal travel and]
