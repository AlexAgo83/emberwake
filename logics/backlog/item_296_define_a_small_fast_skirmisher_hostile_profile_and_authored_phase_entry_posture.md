## item_296_define_a_small_fast_skirmisher_hostile_profile_and_authored_phase_entry_posture - Define a small fast skirmisher hostile profile and authored phase entry posture
> From version: 0.5.1
> Schema version: 1.0
> Status: Done
> Understanding: 95%
...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-a-small-fast-skirmisher-hostile-p|req-080-define-two-new-hostile-archetype|add-a-smaller-faster-hostile-archetype|ac1-the-request-defines-a-bounded
flowchart LR
    Request[req_080_define_two_new_hostile_archetypes_] --> Problem[Add a smaller faster hostile archetype]
    Problem --> Scope[Define a small fast skirmisher hostile]
