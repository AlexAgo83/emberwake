...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-targeted-validation-for-missing-f|req-083-define-a-missing-fusion-completi|complete-the-first-playable-fusion-roste|ac1-the-request-defines-a-bounded
flowchart LR
    Request[req_083_define_a_missing_fusion_completion] --> Problem[Complete the first playable fusion roster]
    Problem --> Scope[Define targeted validation for missing fus]
