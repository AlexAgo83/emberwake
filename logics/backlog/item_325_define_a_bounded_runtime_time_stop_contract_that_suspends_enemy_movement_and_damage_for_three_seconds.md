...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-a-bounded-runtime-time-stop-contr|req-086-define-a-time-stop-hourglass-pic|add-a-new-world-utility-pickup|ac1-the-request-defines-a-bounded
flowchart LR
    Request[req_086_define_a_time_stop_hourglass_picku] --> Problem[Add a new world utility pickup]
    Problem --> Scope[Define a bounded runtime time-stop contrac]
