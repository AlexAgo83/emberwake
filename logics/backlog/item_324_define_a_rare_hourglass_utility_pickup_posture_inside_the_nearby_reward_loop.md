## item_324_define_a_rare_hourglass_utility_pickup_posture_inside_the_nearby_reward_loop - Define a rare hourglass utility pickup posture inside the nearby reward loop
> From version: 0.5.1
> Schema version: 1.0
> Status: Done
> Understanding: 96%
...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-a-rare-hourglass-utility-pickup-p|req-086-define-a-time-stop-hourglass-pic|add-a-new-world-utility-pickup|ac1-the-request-defines-a-bounded
flowchart LR
    Request[req_086_define_a_time_stop_hourglass_picku] --> Problem[Add a new world utility pickup]
    Problem --> Scope[Define a rare hourglass utility pickup]
...
# Closure
- Proof: `games/emberwake/src/runtime/pickupContract.ts`, `games/emberwake/src/runtime/entitySimulationSpawn.ts`, `src/game/entities/render/EntityScene.tsx`.
