## item_294_define_a_1_point_5x_render_scale_contract_for_boss_class_hostile_entities - Define a 1 point 5x render scale contract for boss class hostile entities
> From version: 0.5.1
> Schema version: 1.0
> Status: Done
> Understanding: 96%
...
```mermaid
%% logics-kind: backlog
%% logics-signature: backlog|define-a-1-point-5x-render-scale-contrac|req-079-define-a-1-5x-boss-visual-scale-|make-boss-entities-read-immediately-as|ac1-the-request-defines-a-boss
flowchart LR
    Request[req_079_define_a_1_5x_boss_visual_scale_po] --> Problem[Make boss entities read immediately as]
    Problem --> Scope[Define a 1 point 5x render]
