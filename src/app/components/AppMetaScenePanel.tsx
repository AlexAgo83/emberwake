...
const LazySettingsSceneContent = lazy(() => import("./SettingsSceneContent"));
...
export const AppMetaScenePanel = memo(function AppMetaScenePanel({
  ...
  let handleEscapeAction: (() => void) | null = null;

  if (scene === "main-menu") {
    handleEscapeAction = canResumeSession ? onResumeRuntime : null;
  } else if (
    scene === "new-game" ||
    scene === "changelogs" ||
    scene === "growth" ||
    ...
    handleEscapeAction =
      scene === "settings" && settingsView !== "menu"
        ? () => {
