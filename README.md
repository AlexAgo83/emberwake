...
![Version](https://img.shields.io/badge/version-v0.5.0-4C8BF5)
...
```mermaid
flowchart LR
    Release[v0.5.0 target] --> Main[main branch]
...
- The current release changelog is [`changelogs/CHANGELOGS_0_5_0.md`](changelogs/CHANGELOGS_0_5_0.md).
