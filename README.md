...
![Version](https://img.shields.io/badge/version-v0.7.2-4C8BF5)
...
```mermaid
flowchart LR
    Release[v0.7.2 target] --> Main[main branch]
...
- The current release changelog is [`changelogs/CHANGELOGS_0_7_2.md`](changelogs/CHANGELOGS_0_7_2.md).
