...
![Version](https://img.shields.io/badge/version-v0.7.1-4C8BF5)
...
```mermaid
flowchart LR
    Release[v0.7.1 target] --> Main[main branch]
...
- The current release changelog is [`changelogs/CHANGELOGS_0_7_1.md`](changelogs/CHANGELOGS_0_7_1.md).
