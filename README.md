...
![Version](https://img.shields.io/badge/version-v0.7.0-4C8BF5)
...
```mermaid
flowchart LR
    Release[v0.7.0 target] --> Main[main branch]
...
- The current release changelog is [`changelogs/CHANGELOGS_0_7_0.md`](changelogs/CHANGELOGS_0_7_0.md).
